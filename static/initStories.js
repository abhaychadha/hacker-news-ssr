  ...
  hits: [
    {
      ...
      _highlightResult: {
        title: {
          value: 'macOS High Sierra: Anyone can login as “root” with empty password',
          matchLevel: 'none',
          matchedWords: []
        },
        url: {
          value: 'https://twitter.com/lemiorhan/status/935578694541770752',
          matchLevel: 'none',
          matchedWords: []
        },
        author: {
    ...
    {
      created_at: '2018-10-15T22:00:14.000Z',
      title: 'Paul Allen has died',
      ...
      _highlightResult: {
        title: {
          value: 'Paul Allen has died',
          matchLevel: 'none',
          matchedWords: []
        },
        url: {
          value: 'https://www.cnbc.com/2018/10/15/microsoft-co-founder-paul-allen-dies-of-cancer-at-age-65.html',
          matchLevel: 'none',
          matchedWords: []
        },
        author: {
    ...
    {
      created_at: '2018-06-03T20:14:26.000Z',
      title: 'Microsoft Is Said to Have Agreed to Acquire GitHub',
      url: 'http://www.bloomberg.com/news/articles/2018-06-03/microsoft-is-said-to-have-agreed-to-acquire-coding-site-github?',
      ...
      story_url: null,
      parent_id: null,
      created_at_i: 1528056866,
      relevancy_score: 8159,
      _tags: [
        'story',
        'author_miguelrochefort',
        'story_17221527'
      ],
      objectID: '17221527',
      _highlightResult: {
        title: {
          value: 'Microsoft Is Said to Have Agreed to Acquire GitHub',
          matchLevel: 'none',
          matchedWords: []
        },
        url: {
          value: 'http://www.bloomberg.com/news/articles/2018-06-03/microsoft-is-said-to-have-agreed-to-acquire-coding-site-github?',
          matchLevel: 'none',
          matchedWords: []
        },
        author: {
          value: 'miguelrochefort',
          matchLevel: 'none',
          matchedWords: []
        }
      }
    ...
    {
      created_at: '2019-01-07T17:03:59.000Z',
      ...
      _highlightResult: {
        title: {
          value: 'Announcing unlimited free private repos',
          matchLevel: 'none',
          matchedWords: []
        },
        url: {
          value: 'https://blog.github.com/2019-01-07-new-year-new-github/',
          matchLevel: 'none',
          matchedWords: []
        },
        author: {
    ...
    {
      created_at: '2019-11-20T23:13:09.000Z',
      title: 'Slack’s new WYSIWYG input box is terrible',
      url: 'https://quuxplusone.github.io/blog/2019/11/20/slack-rich-text-box/',
      author: 'ingve',
      points: 2776,
      story_text: null,
      comment_text: null,
      ...
      _highlightResult: {
        title: {
          value: 'Slack’s new WYSIWYG input box is terrible',
          matchLevel: 'none',
          matchedWords: []
        },
        url: {
          value: 'https://quuxplusone.github.io/blog/2019/11/20/slack-rich-text-box/',
          matchLevel: 'none',
          matchedWords: []
        },
        author: {
    ...
    {
      created_at: '2017-09-18T19:45:08.000Z',
      title: 'W3C abandons consensus, standardizes DRM, EFF resigns',
      url: 'https://boingboing.net/2017/09/18/antifeatures-for-all.html',
      author: 'guelo',
      points: 2735,
      story_text: null,
      comment_text: null,
      ...
      _highlightResult: {
        title: {
          value: 'W3C abandons consensus, standardizes DRM, EFF resigns',
          matchLevel: 'none',
          matchedWords: []
        },
        url: {
          value: 'https://boingboing.net/2017/09/18/antifeatures-for-all.html',
          matchLevel: 'none',
          matchedWords: []
        },
        author: {
    ...
    {
      created_at: '2014-03-10T15:44:42.000Z',
      title: '2048',
      ...
      story_url: null,
      parent_id: null,
      created_at_i: 1394466282,
      relevancy_score: 5202,
      _tags: [
        'story',
        'author_frederfred',
        'story_7373566'
      ...
      _highlightResult: {
        ...
        url: {
          value: 'http://gabrielecirulli.github.io/2048/',
          matchLevel: 'none',
          matchedWords: []
        },
        author: {
    ...
    {
      created_at: '2017-03-07T13:10:56.000Z',
      ...
      story_url: null,
      parent_id: null,
      created_at_i: 1488892256,
      relevancy_score: 7299,
      _tags: [
        'story',
        'author_randomname2',
        'story_13810015'
      ...
      _highlightResult: {
        title: {
          value: 'CIA malware and hacking tools',
          matchLevel: 'none',
          matchedWords: []
        },
        url: {
          value: 'https://wikileaks.org/ciav7p1/',
          matchLevel: 'none',
          matchedWords: []
        },
        author: {
    ...
    {
      created_at: '2019-03-14T20:25:03.000Z',
      title: "Show HN: A retro video game console I've been working on in my free time",
      ...
      story_url: null,
      parent_id: null,
      created_at_i: 1552595103,
      relevancy_score: 8710,
      _tags: [
        'story',
        'author_pkiller',
        'story_19393279',
      ...
      _highlightResult: {
        title: {
          value: "Show HN: A retro video game console I've been working on in my free time",
          matchLevel: 'none',
          matchedWords: []
        },
        url: {
          value: 'https://internalregister.github.io/2019/03/14/Homebrew-Console.html',
          matchLevel: 'none',
          matchedWords: []
        },
        author: {
    ...
    {
      created_at: '2013-08-22T17:10:57.000Z',
      title: "Don't Fly During Ramadan",
      url: 'http://varnull.adityamukerjee.net/post/59021412512/dont-fly-during-ramadan',
      author: 'chimeracoder',
      points: 2617,
      story_text: '',
      comment_text: null,
      ...
      story_url: null,
      parent_id: null,
      created_at_i: 1377191457,
      relevancy_score: 4813,
      _tags: [
        'story',
        'author_chimeracoder',
        'story_6258422'
      ...
      _highlightResult: {
        title: {
          value: "Don't Fly During Ramadan",
          matchLevel: 'none',
          matchedWords: []
        },
        url: {
          value: 'http://varnull.adityamukerjee.net/post/59021412512/dont-fly-during-ramadan',
          matchLevel: 'none',
          matchedWords: []
        },
        author: {
